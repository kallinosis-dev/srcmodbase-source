...
BEGIN_VS_SHADER( WorldVertexTransition_DX9, "Help for WorldVertexTransition" )
	...
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM( DROPSHADOWOPACITY, SHADER_PARAM_TYPE_FLOAT, "0.0", "Drop shadow between blended layers" )
		SHADER_PARAM( DROPSHADOWSCALE, SHADER_PARAM_TYPE_FLOAT, "0.0125", "Drop shadow size" )
		SHADER_PARAM( DROPSHADOWHIGHLIGHTSCALE, SHADER_PARAM_TYPE_FLOAT, "0.025", "Highlight size opposite drop shadow effect" )
		SHADER_PARAM( DROPSHADOWDEPTHEXAGGERATION, SHADER_PARAM_TYPE_FLOAT, "4.0", "Drop shadow depth exaggeration" )
	...
	void SetupVars( LightmappedGeneric_DX9_Vars_t& info )
	{
		...
		info.m_nDropShadowOpacity = DROPSHADOWOPACITY;
		info.m_nDropShadowScale = DROPSHADOWSCALE;
		info.m_nDropShadowHighlightScale = DROPSHADOWHIGHLIGHTSCALE;
		info.m_nDropShadowDepthExaggeration = DROPSHADOWDEPTHEXAGGERATION;
