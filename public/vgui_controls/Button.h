...
public:
	...
	Button(Panel *parent, const char *panelName, const char *text, Panel *pActionSignalTarget= nullptr, const char *pCmd= nullptr);
	Button(Panel *parent, const char *panelName, const wchar_t *text, Panel *pActionSignalTarget= nullptr, const char *pCmd= nullptr);
	~Button();
private:
	void Init();
public:
