...
//--------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------
void CProjectGenerator_Makefile::WriteNonConfigSpecificStuff( CUtlBuffer &outBuf ) const
{
...
//--------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------
void CProjectGenerator_Makefile::CollectDependencies( const char *pDependencies, DependencyTable_t &dependenciesOut, const char *pFullFileNameForVisualStudioReplacements /*= nullptr*/ ) const
{
	if ( !pDependencies ||
		!pDependencies[0] )
	{
...
bool CProjectGenerator_Makefile::WriteScriptFile( const char *pFileNameParam, CUtlStringBuilder *pContents, ScriptType_t scriptType ) const
{
