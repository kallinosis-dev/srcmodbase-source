...
protected:
	...
	char const* m_pParticleInnerNearDef; //Name of the first inner system
	char const* m_pParticleInnerFarDef;  //Name of the second inner system
	char const* m_pParticleOuterDef;     //Name of the outer system
