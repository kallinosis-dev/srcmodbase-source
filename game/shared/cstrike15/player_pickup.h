...
public:
	...
	virtual bool			HasPreferredCarryAnglesForPlayer( CBasePlayer *pPlayer = nullptr) = 0;
...
public:
	...
	virtual CBaseEntity		*OnFailedPhysGunPickup( Vector vPhysgunPos ) { return nullptr; }
